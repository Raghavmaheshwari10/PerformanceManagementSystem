...
const NAV_ITEMS: Record<UserRole, NavItem[]> = {
  employee: [
    ...
    { label: 'Peer Reviews', href: '/employee/peer-reviews' },
  ...
  hrbp: [
    ...
    { label: 'Employees',   href: '/hrbp/employees' },
    { label: 'Reports',     href: '/hrbp/reports' },
  ...
  admin: [
    ...
    { label: 'Review Templates', href: '/admin/review-templates' },
