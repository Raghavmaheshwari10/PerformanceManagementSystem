  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
        <h2 className="text-lg font-semibold text-gray-900">Org Target</h2>
        ...
        <form action={orgAction} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full max-w-xs rounded-lg border border-gray-200 bg-white px-3 py-2 pl-7 text-sm text-gray-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500"
                placeholder="0.00"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-6 gap-2">
              {MONTHS.map((m) => (
                <div key={m}>
                  <label className="block text-[10px] text-slate-400 mb-0.5 uppercase">{MONTH_LABELS[m]}</label>
                  <input
                    type="number"
                    name={m}
                    step="0.01"
                    ...
                    className="w-full rounded-lg border border-gray-200 bg-white px-2 py-1.5 text-sm text-gray-900 text-right placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/40"
                    placeholder="0"
                  />
                </div>
              ))}
          ...
          <div className="flex items-center justify-between pt-2">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="font-mono text-gray-900">&#8377;{formatLacs(orgMonthlySum)}</span>
              {orgAnnualNum > 0 && (
                orgValid ? (
      ...
      {orgAopId && (
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">Department Split</h2>
              ...
              <table className="w-full text-sm min-w-[900px]">
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-50">
                    <th className="text-left py-2 pr-3 text-xs font-medium text-gray-500 uppercase tracking-wider w-[140px]">Department</th>
                ...
                <tbody>
                  {departments.map((dept) => {
                    ...
                    return (
                      <tr key={dept.id} className="border-b border-gray-200 hover:bg-gray-50">
                        <td className="py-2 pr-3 text-gray-900 text-xs font-medium">{dept.name}</td>
                  ...
                  <tr className="border-t border-gray-200 bg-gray-50">
                    <td className="py-2 pr-3 text-xs font-semibold text-gray-700">Total</td>
                  ...
                  <tr className="bg-gray-50">
                    <td className="py-2 pr-3 text-xs font-semibold text-slate-500">Org Target</td>
                  ...
                  {/* Diff row */}
                  <tr>
                    <td className="py-2 pr-3 text-xs font-semibold text-slate-500">Diff</td>
                    <td className={`py-2 px-2 text-right text-xs font-mono ${deptAnnualMatch ? 'text-green-600' : 'text-red-600'}`}>
                      {deptAnnualMatch ? (
                    ...
                    {MONTHS.map((m) => {
                      ...
                      return (
                        <td key={m} className={`py-2 px-1 text-right text-[11px] font-mono ${match ? 'text-green-600' : 'text-red-600'}`}>
                          {match ? (
