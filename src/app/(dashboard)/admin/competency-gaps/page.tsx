...
async function CompetencyGapContent() {
  ...
  if (!latestCycleId) {
    return <CompetencyGapDashboard role="admin" rows={[]} stats={{ competencies: [], overallAvg: {}, deptAvg: {}, lowestCompetency: null, lowestDept: null, overallScore: 0 }} trends={[]} cycles={[]} selectedCycleId="" departments={[]} />
  }
